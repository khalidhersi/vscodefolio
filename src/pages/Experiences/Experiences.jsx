    ...
    <div className="experiences">
      <div className="experiences__container experience">
        ...
        <ul className="experiences__list">
          <li className="experiences__list__ltems">
            Civil Engineering BEng Undergraduate degree{" "}
            <span className="text-accent">Sept 2017 - Aug 2020.</span>
          </li>
          <li className="experiences__list__ltems">
            12 Week BootCapm At _nology{" "}
            <span className="text-accent">Oct 2021 - Jan 2022.</span>
          </li>
        </ul>
      </div>
